    ...
    <div ref={containerRef} className="min-w-0 flex-1 font-mono text-sm text-foreground">
      ...
      {isOpen ? (
        <div
          ...
          ref={panelRef}
          tabIndex={-1}
          className="mt-2 border-y border-border/70 py-2"
        >
          ...
          {labs.map((lab, index) => {
            ...
            return (
              <button
                ...
                className={`grid w-full min-w-0 grid-cols-[2.5rem_minmax(3rem,auto)_minmax(0,1fr)_auto] items-center gap-2 px-3 py-2 text-left transition focus-visible:ring-3 focus-visible:ring-ring/50 @sm:gap-3 ${
                  active
