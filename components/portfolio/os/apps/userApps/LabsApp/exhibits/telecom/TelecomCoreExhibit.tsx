    ...
    <LabExhibitLayout
        ...
        <LabExhibitControls
          playLabel={
            lab.isSimulating
              ? "Flow running..."
              : lab.isComplete
                ? "Replay animated flow"
                : lab.scenario.trigger
          }
          onPlay={lab.start}
      ...
      stepPanel={
        <LiveStepPanel
          ...
          description={
            lab.isComplete
              ? "Billing outcome received. The subscriber event completed the production path."
              : lab.activeStage.description
          }
