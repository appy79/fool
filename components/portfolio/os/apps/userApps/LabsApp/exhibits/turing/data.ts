    ...
    insightSteps: [
      {
        ...
        description:
          "The head starts on the most significant bit and scans right without changing the input.",
      },
      {
        title: "Keep scanning toward the end",
        description:
          "The machine stays in scan-right while crossing the middle bits of the binary number.",
      },
      {
        title: "Reach the least significant side",
        description:
          "Another right move brings the head closer to the blank that marks the end of the number.",
      },
      {
  ...
  steps: [
    {
      ...
      description:
        "The head is aligned over one cell, and the current state plus symbol selects a transition.",
    },
    {
      title: "Apply the transition rule",
      description:
        "The machine writes a symbol, chooses the next state, and decides whether to move left, right, or stay.",
    },
    {
      title: "Shift tape under the head",
      description:
        "The visible tape moves so the next memory cell becomes active for the following step.",
    },
    {
      title: "Halt, accept, reject, or continue",
      description:
        "The current state determines whether computation has finished or another transition is required.",
    },
  ],
  concepts: [
    {
      ...
      description:
        "The active state is the machine's finite control. It decides how to interpret the symbol under the head.",
      bullets: [
