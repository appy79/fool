...
export const designPatternScenarios = [
  {
    ...
    summary:
      "A context delegates variable behavior to a strategy interface, allowing concrete algorithms to be selected without changing the caller.",
    parts: [
      "Request",
      "Context Policy",
      "Strategy Registry",
    ...
    insightSteps: [
      {
        ...
        description:
          "The caller asks the context for a result and does not contain branching logic for every algorithm.",
      },
      {
        title: "Context evaluates selection policy",
        description:
          "The context chooses which strategy key to use based on runtime policy, injected configuration, or request shape.",
      },
      {
        title: "Registry resolves the implementation",
        description:
          "A registry or dependency-injected map returns a concrete strategy behind the same interface.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The caller gets the final result without depending on concrete strategy classes.",
      },
    ],
  },
  {
    ...
    summary:
      "A target interface and adapter translate between modern callers and incompatible legacy contracts without leaking old payload details upstream.",
    parts: [
      "Target Request",
      "Adapter Boundary",
      "Map DTO",
    ...
    insightSteps: [
      ...
      },
      {
        ...
        description:
          "The adapter implements the target interface that the rest of the codebase wants to use.",
      },
      {
        title: "Adapter maps request DTO",
        description:
          "The adapter converts naming, payload shape, protocol expectations, and error semantics.",
      },
      {
        title: "Legacy SOA executes behind the boundary",
        description:
          "The old request format and dependency call exist only behind the adapter boundary.",
      },
      {
        title: "Legacy response is mapped back",
        description:
          "Legacy status codes, field names, and errors are normalized into the target model.",
      },
      {
  ...
  },
  {
    ...
    summary:
      "A publisher emits one event into a subject/bus, and independent subscribers react without being named by the publisher.",
    parts: [
      "Domain Event",
      "Publish",
      "Fan-out Queue",
    ...
    insightSteps: [
      {
        ...
        description:
          "The publisher records one event describing what happened, without naming downstream consumers.",
      },
      {
        title: "Event is published once",
        description:
          "The subject or event bus receives the event and becomes the fan-out boundary.",
      },
      {
        title: "Fan-out queues subscriber deliveries",
        description:
          "Each subscriber gets its own delivery lane so one slow consumer does not block all others.",
      },
      {
        title: "Subscribers consume independently",
        description:
          "Audit, email, and cache handlers react to the same event with separate responsibilities.",
      },
      {
        title: "Acks and retries are handled",
        description:
          "Each consumer acknowledges success or retries idempotently if its side effect fails.",
      },
      {
        title: "Side effects complete separately",
        description:
          "Subscribers may finish at different times, so retries, ordering, and idempotency matter.",
      },
    ],
  },
  {
    ...
    summary:
      "A breaker tracks dependency failures, opens to fail fast, serves fallback, then probes recovery before closing again.",
    parts: [
      "Request",
      "Closed Pass",
      "Failures Counted",
    ...
    insightSteps: [
      ...
      },
      {
        ...
        description:
          "In the closed state the breaker allows calls while tracking failures and latency.",
      },
      {
        title: "Dependency failures accumulate",
        description:
          "The breaker observes timeout/error thresholds as the dependency becomes unsafe.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The fallback branch returns a degraded but controlled outcome while the dependency recovers.",
      },
      {
        title: "Half-open probe tests recovery",
        description:
          "After a cooldown, a limited probe decides whether the breaker can close or should reopen.",
      },
    ],
  },
  ...
  steps: [
    {
      ...
      description:
        "The first node represents the code or service that needs behavior, translation, notification, or protection.",
    },
    {
      title: "Pattern boundary takes responsibility",
      description:
        "The selected pattern absorbs variation, mismatch, fan-out, or failure handling.",
    },
    {
      title: "Implementation detail is isolated",
      description:
        "Algorithm, legacy service, subscriber, or dependency behavior stays behind a clearer boundary.",
    },
    {
      title: "Result exposes the tradeoff",
      description:
        "The final node shows the benefit and the complexity cost introduced by the pattern.",
    },
  ],
  concepts: [
    {
      ...
      description:
        "A useful design pattern creates a stable boundary around variation, mismatch, fan-out, or failure.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "Patterns are not free; each one buys flexibility by introducing more structure.",
      bullets: [
