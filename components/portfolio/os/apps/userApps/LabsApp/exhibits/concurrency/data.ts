    ...
    insightSteps: [
      {
        ...
        description:
          "All four threads are schedulable and no primitive protects the shared counter.",
      },
      {
        title: "Every thread reads the same stale value",
        description:
          "The animation shows each worker copying the same counter value into local state.",
      },
      {
        title: "Each worker computes +1 locally",
        description:
          "The local calculations are individually correct but based on the same old snapshot.",
      },
      {
        title: "Writes collide and updates are lost",
        description:
          "All workers write the same result, so throughput looks high while correctness fails.",
      },
    ],
  },
  {
    ...
    summary:
      "Threads serialize access through a mutex so the counter is correct, but contention appears.",
    workers: 4,
    observedIncrement: 4,
    phases: [
      "Ready",
    ...
    insightSteps: [
      {
        ...
        description:
          "All threads attempt to enter the critical section, but the mutex enforces mutual exclusion.",
      },
      {
        title: "T1 acquires and commits",
        description:
          "T1 obtains the lock first, increments the shared register safely to 1, and releases the lock.",
      },
      {
        title: "T2 takes its turn",
        description:
          "T2 enters the critical section next, reads the fresh value of 1, increments to 2, and releases the lock.",
      },
      {
        title: "T3 takes its turn",
        description:
          "T3 gets the lock, reads the value 2, increments the register to 3, preserving perfect serialization.",
      },
      {
        title: "T4 completes sequence",
        description:
          "T4 runs the final safe update to 4. Zero updates are lost, though serialization was required.",
      },
      {
        title: "All threads committed",
        description:
          "Correctness is restored, with visible serialization as the performance tradeoff.",
      },
    ],
  },
  {
    ...
    summary:
      "The counter update becomes one linearizable hardware operation, preserving correctness without a broad mutex.",
    workers: 4,
    observedIncrement: 4,
    phases: [
      "Ready",
    ...
    insightSteps: [
      {
        ...
        description:
          "The CPU atomic instruction allows safe, concurrent updates without a broad critical section.",
      },
      {
        title: "T1 atomic operation",
        description:
          "T1 executes a linearizable atomic increment, successfully moving the register to 1.",
      },
      {
        title: "T2 atomic operation",
        description:
          "T2's atomic increment is ordered after T1 at the memory location, moving the register to 2.",
      },
      {
        title: "T3 atomic operation",
        description:
          "T3 commits its atomic increment to 3 safely without holding any high-level mutex.",
      },
      {
        title: "T4 atomic operation",
        description:
          "T4 executes the final atomic update to write 4. The cache-coherence protocol serializes the memory location.",
      },
      {
        title: "All increments completed",
        description:
          "All increments land without the larger lock overhead of a user-space critical section.",
      },
    ],
  },
  {
    ...
    summary:
      "A semaphore bounds how many workers may use a limited resource at once; it is not a mutex for one shared variable.",
    workers: 4,
    observedIncrement: 4,
    phases: [
      "Ready",
    ...
    insightSteps: [
      {
        ...
        description:
          "The semaphore is initialized with 2 permits, so up to 2 workers can use the bounded resource.",
      },
      {
        title: "T1 and T2 use permits",
        description:
          "T1 and T2 check out the two available permits and run concurrently, while T3/T4 wait.",
      },
      {
        title: "T1 and T2 release",
        description:
          "T1 and T2 finish their bounded-resource work, record completion, and return permits to the pool.",
      },
      {
      ...
      },
      {
        ...
        description:
          "T3 and T4 complete their bounded-resource work and record the final completions.",
      },
      {
        title: "Permits fully released",
        description:
          "All threads have run. Parallelism was bounded at exactly 2 resource users, but shared data still needs its own protection.",
      },
    ],
  },
  {
    ...
    trigger: "Queue tasks",
    summary:
      "Workers avoid shared counter races by sending increments through a queue-owned reducer.",
    workers: 4,
    observedIncrement: 4,
    phases: ["Ready", "Enqueue Messages", "Drain T1 & T2", "Drain T3 & T4", "All Completed"],
    metrics: [
      { label: "Correctness", value: "Exact" },
    ...
    insightSteps: [
      {
        ...
        description:
          "Threads produce +1 increment messages and push them into the thread-safe work queue.",
      },
      {
        title: "Deltas buffered in queue",
        description:
          "The queue holds the concurrent messages, absorbing load spikes and acting as a buffer.",
      },
      {
        title: "Single-threaded drain 1",
        description:
          "A dedicated single-threaded reducer drains and processes the first two messages, updating the register to 2.",
      },
      {
        title: "Single-threaded drain 2",
        description:
          "The reducer processes the remaining two messages to write 4, avoiding lock contention entirely.",
      },
      {
        title: "All tasks drained",
        description:
          "Correctness comes from ownership transfer and backpressure rather than locks around every worker.",
      },
    ],
  },
  {
    ...
    workers: 2,
    observedIncrement: 0,
    phases: ["Ready", "Thread A locks X", "Thread B locks Y", "A waits for Y", "B waits for X"],
    metrics: [
    ...
    insightSteps: [
      ...
      },
      {
        title: "B waits for X",
        description:
          "B attempts to acquire X. Both workers now wait forever in a circular dependency.",
      },
    ],
  },
  {
    ...
    workers: 4,
    observedIncrement: 4,
    phases: ["Ready", "Fork workers", "Private memory", "Parallel compute", "Merge result"],
    metrics: [
    ...
    insightSteps: [
      ...
      },
      {
        ...
        description:
          "The workers become separate processes rather than threads sharing one memory space.",
      },
      {
      ...
      },
      {
        ...
        description:
          "CPU-bound work can use multiple cores because each process runs independently.",
      },
      {
  ...
  steps: [
    {
      ...
      description:
        "Threads or processes are ready to act on a shared counter, private memory, or queue.",
    },
    {
      title: "Access rule is applied",
      description:
        "The selected primitive controls whether workers read freely, acquire locks, enqueue work, or wait.",
    },
    {
      title: "Local work or contention appears",
      description:
        "The animation shows stale reads, serialized access, atomic execution, reducer ownership, or circular wait.",
    },
    {
      title: "Final state proves correctness",
      description:
        "Expected and observed counters reveal exact updates, lost updates, or no progress.",
    },
  ],
  concepts: [
    {
      ...
      description:
        "Concurrent workers can interleave reads and writes in ways that make simple code incorrect.",
      bullets: [
